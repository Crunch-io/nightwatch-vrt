...
const CHROME_PATH = path.join(
	BINPATH,
	"chromedriver",
	CHROME_DRIVER_VERSION + "-" + process.arch + "-" + "chromedriver"
);
...
const GECKO_PATH = path.join(
	BINPATH,
	"geckodriver",
	GECKO_DRIVER_VERSION + "-" + process.arch + "-" + "geckodriver"
);
const GHOST_DRIVER_VERSION = "2.1.0"; // https://github.com/detro/ghostdriver/releases
const GHOST_PATH = "2.1.0";
const PHANTOMJS_PATH = path.join(
	__dirname,
	"node_modules",
	"phantomjs-prebuilt",
	"bin",
